...
export const projects: Project[] = [
  {
    title: "CongruentC",
    description:
      "A suite of reusable C tools designed with consistent conventions and minimal dependencies, so core utilities like string views and dynamic arrays can be dropped into real projects quickly.",
    features: [
      "stb-style single-header design with one implementation define",
      "Consistent naming and memory model across all tools",
      "Core utilities including string view, dynamic array, string builder, and hash map",
      "Includes cheaders tooling to auto-generate header files from source files",
    ],
    contribution:
  ...
  {
    title: "Artificial Life — Evolved Creature Simulation",
    description:
      "A from-scratch artificial life system in C where spring-and-node creatures evolve locomotion strategies over generations using a genetic algorithm, with a companion bare-metal ARM port for constrained hardware.",
    features: [
      "Custom Verlet integration physics engine with spring constraints",
      "Genome-driven creature morphology and muscle timing system",
      "Selection, mutation, and generational evolution loop",
      "Bare-metal ARM microcontroller port targeting TFT rendering over SPI",
    ],
    contribution:
      "Built the simulation stack end-to-end, including physics, rendering, evolutionary logic, and a no-OS constrained embedded port architecture.",
    tech: [
      "C",
      "SDL3",
      "Genetic algorithms",
