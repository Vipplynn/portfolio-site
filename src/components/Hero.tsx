        ...
        >
          <div>
            ...
            <p className="text-gray-700 mb-8 max-w-prose md:max-w-md mx-auto md:mx-0 text-justify text-lg leading-relaxed">
              I’m a second-year Computer Science student at Simon Fraser
              University, building a strong foundation in full-stack
              development. I’m passionate about creating scalable, user-focused
              software and continuously improving as a developer and
              collaborator.
            </p>
          </div>
